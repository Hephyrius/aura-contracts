...
task("deploy:goerli:11").setAction(async function (_: TaskArguments, hre) {
...
task("deploy:goerli:2").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("deploy:goerli:3").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("deploy:goerli:4").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("deploy:goerli:6").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("deploy:goerli:7").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("deploy:goerli:temp-booster").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
    const tempBooster = await deployTempBooster(hre, deployer, true, 3);
    logContracts({ tempBooster });
});

task("deploy:goerli:merkledrop")
...
task("goerli:getgauges").setAction(async function (_: TaskArguments, hre) {
    const { ethers } = hre;
...
task("goerli:getStashes").setAction(async function (_: TaskArguments, hre) {
    const deployer = await getSigner(hre);
...
task("goerli:siphon").setAction(async function (_: TaskArguments, hre) {
    const debug = true;
